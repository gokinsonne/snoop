...
export function LongformGuide({ path, eyebrow, title, intro, facts, sections, related }: Props) {
  return <>
    <ArticleSchema path={path} title={title} description={intro} section="Slot guides" published="2026-08-05" modified="2026-08-27" />
    ...
    <main className="bg-[#080b09] text-neutral-100"><article className="mx-auto max-w-5xl px-5 py-16 sm:py-24">
      <p className="text-sm font-black uppercase tracking-[.2em] text-emerald-400">{eyebrow}</p><h1 className="mt-4 max-w-4xl text-4xl font-black tracking-tight sm:text-6xl">{title}</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-neutral-300">{intro}</p><p className="mt-4 text-sm text-neutral-500"><time dateTime="2026-08-27">Updated 27 August 2026</time> · Editorial guide</p>
