...
export const metadata: Metadata = {
  title: {
    absolute: "Snoop Dogg Dollars Demo: Play Free Online (No Download)",
  },
  description:
    "Play Snoop Dogg Dollars demo free online with virtual credits. No download, sign-up or deposit. Test Cluster Pays, Snoop Spin and bonus features.",
  keywords: [
      ...
      <main className="min-h-screen bg-black text-neutral-100">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-6">
            Snoop Dogg Dollars Demo — Play Free Online
          </h1>
