...
const routes = [
  ...
  "/research/crypto-casino-keyword-landscape",
  "/vs-aztec-clusters",
...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated20September = new Set(["", "/review", "/demo", "/casinos", "/how-to-play"])
  const updated12September = new Set(["/bonus", "/casinos", "/crypto-casinos", "/crypto-casino-bonuses", "/crypto-casino-kyc", "/instant-withdrawal-crypto-casinos", "/research/crypto-casino-keyword-landscape"])
  ...
  return routes.map((route) => ({
    ...
    lastModified: updated20September.has(route)
      ? new Date("2026-09-20")
      : updated12September.has(route)
      ? new Date("2026-09-12")
      : updated9September.has(route)
      ? new Date("2026-09-09")
      : updated8September.has(route)
      ? new Date("2026-09-08")
      : updated5September.has(route)
      ? new Date("2026-09-05")
