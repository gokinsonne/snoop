...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated22August = new Set(["", "/demo", "/review", "/rtp", "/bonus", "/casinos", "/faq", "/free-spins", "/max-win", "/how-to-play", "/strategy", "/mobile", "/play-in-india", "/play-in-japan", "/vs-sugar-rush", "/crypto-casinos/snoop-dogg-dollars", "/bitcoin-casinos/snoop-dogg-dollars", "/usdt-casinos/snoop-dogg-dollars"])
  ...
  return routes.map((route) => ({
    ...
    lastModified: updated22August.has(route)
      ? new Date("2026-08-22")
