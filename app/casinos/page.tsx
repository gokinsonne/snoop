...
export const metadata: Metadata = {
  title: "Where to Play Snoop Dogg Dollars | Best Casinos & Bonuses 2025",
  description:
    "Find the best casinos to play Snoop Dogg Dollars. Compare bonuses, RTP, and withdrawal speed. 1WIN offers 200% bonus + 100 free spins. Start winning today.",
  keywords: [
...
const casinos = [
  {
    ...
    cta: "Claim Bonus",
    link: "https://1win.com?ref=HOLY1WIN",
    rtp: "97%",
    minDeposit: "$1",
    rating: 4.9,
  },
  {
    name: "Roobet",
    badge: "Exclusive",
    bonus: "Roowards loyalty program + rakeback",
    highlights: ["Original launch partner", "Crypto-only", "Provably fair", "Instant withdrawals"],
    cta: "Play Now",
  ...
  },
  {
    ...
    highlights: ["Award-winning casino", "Mixed crypto & fiat", "Fast payouts", "Huge game library"],
    cta: "Join Now",
  ...
  },
  {
    name: "Stake",
    badge: "Popular",
    bonus: "VIP rakeback + weekly boosts",
    highlights: ["Community-driven", "Crypto sportsbook", "Original games", "Streaming hub"],
    cta: "Get Started",
